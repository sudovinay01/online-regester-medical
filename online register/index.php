<?php
	...
	else
	{
		if (isset($_POST['submit']))
		{
			...
			$sql="SELECT * FROM `members` where `name`='$name' AND `type`='member'";
...
<body class=" w3-light-grey">
	...
	<nav class="w3-container w3-card-4  w3-white  w3-margin-bottom w3-padding">
		<a href="admin/admin_login.php" class="w3-blue w3-padding w3-btn" style="text-decoration: none;">Admin Login</a>
	</nav>
